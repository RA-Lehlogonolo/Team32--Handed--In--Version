...
{
    public abstract class VillageBoardWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static VillageBoardWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(VillageBoardWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<VillageBoardDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<VillageBoardDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<VillageBoardDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<VillageBoardDbContext, Task<T>> func)
        {
            T result;
