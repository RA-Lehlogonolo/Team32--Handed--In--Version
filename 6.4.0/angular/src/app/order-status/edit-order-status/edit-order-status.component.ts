...
export class EditOrderStatusDialogComponent extends AppComponentBase
  ...
  saving = false;
  id: number;
  OrderStatus = new OrderStatusEditDto();
  ...
  ngOnInit(): void {
    this._OrderStatusService
      .getOrderStatusForEdit(this.id)
      .subscribe((result: GetOrderStatusForEditOutput) => {
